...
VALUES
    (
        ...
        'MI',
        'Ann Arbor',
        'I currently work at CAEN IT Web Services for Michigan Engineering. As a Student Web Developer, I deal with the creation and maintenance of many departments’ web applications using WordPress. A main thing I do is migrate existing sites to a WordPress site, so the site owner is able to maintain and change their existing site on a platform that needs little to none coding experience. This makes managing upwards to 300 different sites for faculty, laboratories, departments, organizations, etc. a much more feasible task. With the end goal of site owners and users being happy and enjoying the final product.',
        2022,
        2024,
        'Jul',
        'Present'
